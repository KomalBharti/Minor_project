          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" action="AddStudent">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword4">RF-ID</label>
                    <input type="text" class="form-control" id="exampleInputPassword4" placeholder="RF-ID" name="RF-ID">
                  </div>
                  <div class="form-group">
